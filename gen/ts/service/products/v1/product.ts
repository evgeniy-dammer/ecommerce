...
// @generated from protobuf file "service/products/v1/product.proto" (package "ecommerce.products.v1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message ecommerce.products.v1.Product
 */
...
class Product$Type extends MessageType<Product> {
    constructor() {
        super("ecommerce.products.v1.Product", [
...
/**
 * @generated MessageType for protobuf message ecommerce.products.v1.Product
 */
